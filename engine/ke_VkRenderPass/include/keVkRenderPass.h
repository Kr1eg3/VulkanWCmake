...
public:
	...
	void createRenderPass(VkDevice vkDevice, VkPhysicalDevice vkPhysicalDevice,
		VkFormat vkSwapChainImageFormat);
	VkRenderPass getRenderPass();

private:
	VkFormat findDepthFormat(VkPhysicalDevice vkPhysicalDevice);
	VkFormat findSupportedFormat(VkPhysicalDevice vkPhysicalDevice,
